        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              Were happy to receive your order and will be in touch with you
              shortly. Delivery Usually Takes 3-7 Days.
            </Text>
            <Text style={{ ...global.text, marginTop: 24 }}>
              If you have any questions, please contact with Your Order Details,
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                ...
                this Email, Your Reply We Won't be Able to See it.)
              </Text>
            </Row>
            <Row>
              <Text style={footer.text}>
                © 2023 Caseome. All rights reserved.
              </Text>
            </Row>
          </Section>
        </Container>
